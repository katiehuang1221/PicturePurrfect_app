...
# Name custom object
# classes = ["Koala"]
classes = ["cat eye", "cat_ear", "cat_nose"]

# Images path
# images_path = glob.glob(r"D:\Pysource\Youtube\2020\105) Train Yolo google cloud\dataset\*.jpg")
images_path = glob.glob(r"/Users/katiehuang/Documents/best_cat/YOLO_detection/cat_face.jpg")
...
for img_path in images_path:
    ...
    for i in range(len(boxes)):
        if i in indexes:
            ...
            cv2.putText(img, label, (x, y + h +20), font, 1, color, 2)
